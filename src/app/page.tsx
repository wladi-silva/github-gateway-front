...
import { fetchUser, fetchRepositories } from './services/serviceGateway';
    ...
    return (
        <div className="p-4">
            ...
            <div className="relative min-h-80 w-full flex flex-col items-center bg-white p-2 shadow-sm border border-slate-200 rounded-lg mt-4">
                {error && (
                    <div
                        className="flex items-center justify-center bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mt-4 w-full max-w-md"
                        role="alert"
                    >
